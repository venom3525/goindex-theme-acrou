...
// Set up libraries that do not participate in the construction
let externals = {};
...
module.exports = {
  ...
  chainWebpack: (config) => {
     ...
     * And the prefetch tag generated during pre-rendering is the modern version, which is not needed for lower version browser
     */
    if (isProd) {
